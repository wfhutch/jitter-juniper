...
namespace Jitter.Tests.Models
{
    ...
    public class JitterRepositoryTests
    {
        ...
        [TestMethod]
        public void JitterRepositoryHandlingGetUserByHandleUserDoesNotExist()
        {
            //Arrange
            var expected = new List<JitterUser>
            {
        ...
        [TestMethod]
        public void JitterRepositoryEnsureICanSearchHandle()
        {
            //Arrange
            var expected = new List<JitterUser>
            {
            ...
            //Assert
            // Collection Assert doesn'tuse compareTo underneath the hood.
